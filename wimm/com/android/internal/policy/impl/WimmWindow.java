 ...
 * in android.widget.
 */
public class WimmWindow extends Window implements MenuBuilder.Callback {
    private final static String TAG = "WimmWindow";
    ...
    public WimmWindow(Context context) {
        super(context);
